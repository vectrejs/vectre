...
function (_super) {
  ...
  Avatar = __decorate([vuePropertyDecorator.Component], Avatar);
  return Avatar;
}(Vue);
...
function (_super) {
  ...
  Card = __decorate([vuePropertyDecorator.Component], Card);
  return Card;
}(Vue);
...
function (_super) {
  ...
  Bar = __decorate([vuePropertyDecorator.Component], Bar);
  return Bar;
}(Vue);
...
function (_super) {
  ...
  Breadcrumb = __decorate([vuePropertyDecorator.Component], Breadcrumb);
  return Breadcrumb;
}(Vue);
...
function (_super) {
  ...
  Chip = __decorate([vuePropertyDecorator.Component({
    components: {
      Avatar: Avatar$1
    }
  })], Chip);
...
function (_super) {
  ...
  Empty = __decorate([vuePropertyDecorator.Component({
    components: {
      Icon: Icon$1
    }
  })], Empty);
...
function (_super) {
  ...
  default_1 = __decorate([vuePropertyDecorator.Component], default_1);
  return default_1;
}(Vue);
