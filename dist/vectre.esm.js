import Vue from 'vue';
import { Prop, Component as Component$2, Emit } from 'vue-property-decorator';
...
function (_super) {
  ...
  Icon = __decorate([Component$2], Icon);
  return Icon;
}(Vue);
...
function (_super) {
  ...
  Accordion = __decorate([Component$2({
    components: {
      Icon: Icon$1
    }
  })], Accordion);
...
function (_super) {
  ...
  Divider = __decorate([Component$2], Divider);
  return Divider;
}(Vue);
...
function (_super) {
  ...
  MenuBadge = __decorate([Component$2], MenuBadge);
  return MenuBadge;
}(Vue);
...
function (_super) {
  ...
  VerticalMenu = __decorate([Component$2({
    components: {
      Badge: Badge
    }
  })], VerticalMenu);
...
function (_super) {
  ...
  DropdownMenu = __decorate([Component$2({
    components: {
...
function (_super) {
  ...
  OffCanvas = __decorate([Component$2({
    components: {
      icon: Icon$1
    }
  })], OffCanvas);
...
function (_super) {
  ...
  SimplePager = __decorate([Component$2], SimplePager);
  return SimplePager;
}(Vue);
...
function (_super) {
  ...
  Pager = __decorate([Component$2], Pager);
  return Pager;
}(Vue);
...
function (_super) {
  ...
  Pagination = __decorate([Component$2({
    components: {
...
function (_super) {
  ...
  Toast = __decorate([Component$2], Toast);
  return Toast;
}(Vue);
...
function (_super) {
  ...
  Navigation = __decorate([Component$2({
    name: 'navigation'
  })], Navigation);
  return Navigation;
}(Vue);
...
function (_super) {
  ...
  Group = __decorate([Component$2], Group);
  return Group;
}(VueComponent);
...
function (_super) {
  ...
  Checkbox = __decorate([Component$2({
    model: {
      event: 'input',
      prop: 'model'
    }
...
function (_super) {
  ...
  Input = __decorate([Component$2], Input);
  return Input;
}(VueComponent);
...
function (_super) {
  ...
  IconContainer = __decorate([Component$2], IconContainer);
...
function (_super) {
  ...
  Option = __decorate([Component$2], Option);
  return Option;
}(VueComponent);
...
function (_super) {
  ...
  Select = __decorate([Component$2], Select);
  return Select;
}(VueComponent);
